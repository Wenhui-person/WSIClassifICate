...
parser = argparse.ArgumentParser(description='Generate patches from a given '
                                 'list of coordinates')
parser.add_argument('--coords_path', default="/home/qianslab/yangwenhui/TUMOR_data_processed/bag_files/testset_normal_spot_in_wsi.txt", metavar='COORDS_PATH',
                    type=str, help='Path to the input list of coordinates')
parser.add_argument('--patch_path', default="/home/qianslab/yangwenhui/TUMOR_data_processed/test_patch/normal", metavar='PATCH_PATH', type=str,
...
def run(args):
    ...
    for i, line in enumerate(infile):
        ...
        opts_list.append((i, slide_path, x_center, y_center, args))
    infile.close()
