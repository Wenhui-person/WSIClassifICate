...
parser.add_argument('--wsi_path', default='/media/qianslab/Data/Cervical-cancer-data/wsi/tumor/tumor57.tif', metavar='WSI_PATH', type=str,
                    help='Path to the input WSI file')
parser.add_argument('--ckpt_path', default='/home/qianslab/yangwenhui/results/best_2.ckpt', metavar='CKPT_PATH', type=str,
                    help='Path to the saved ckpt file of a pytorch model')
parser.add_argument('--cnn_path', default='/home/qianslab/yangwenhui/results/cfg_2.json', metavar='CNN_PATH', type=str,
                    help='Path to the config file in json format related to'
                    ' the ckpt file')
parser.add_argument('--mask_path', default='/home/qianslab/yangwenhui/Multiple Instance Learning manuscript1/code/wsiClassification/draw/tumor_mask.npy', metavar='MASK_PATH', type=str,
                    help='Path to the tissue mask of the input WSI file')
parser.add_argument('--probs_map_path', default='probs_map', metavar='PROBS_MAP_PATH',
...
def make_dataloader(args, cnn, flip='NONE', rotate='NONE'):
    batch_size = cnn['sup_batch_size'] * 2
