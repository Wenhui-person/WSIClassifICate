...
class Mask(object):
    ...
    def tumor_mask(self, in_xml):
        ...
        np.save('tumor_mask.npy', mask_tumor)
        return mask_tumor
...
if __name__ == '__main__':
    mask = Mask('/media/qianslab/Data/Cervical-cancer-data/wsi/tumor/tumor57.tif', 5, 3)
    img = mask.tissue_mask()
    tumor_mask = mask.tumor_mask('/media/qianslab/Data/Cervical-cancer-data/xml/tumor57.xml')
    print(tumor_mask)
